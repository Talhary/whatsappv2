...
module.exports = ytd =async(client, m, text,itag) => {
    return client.sendMessage(m.sender,{document:{url:`https://youtube-player-2bad53bddb91.herokuapp.com/api/v1/video?url=${text}`},mimetype:'video/mp4',fileName:'video.mp4'});
